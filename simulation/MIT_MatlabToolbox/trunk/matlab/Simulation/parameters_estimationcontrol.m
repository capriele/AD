...
controlHelperParams.takeoff_gain                = 0.01;   %drone takes off with constant thrust x% above hover thrust
...
controlHelperParams.motorsThrustperMotor_max    = (quadEDT.maxomega)^2*quad.Ct*quad.rho*quad.A*quad.r^2;
