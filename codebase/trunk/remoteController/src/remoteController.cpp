...
gboolean podBase_t::gtimerfuncComputations (gpointer data) {
	 ...
	 if ( !remoteController_t::kbhit() )
		...
		else if (podWorker->controllerAdjustmode == CADJUSTMODE_BIAS)		
			{
			switch (ch)
				{
				//control mode cases
		...
		else if (podWorker->controllerAdjustmode == CADJUSTMODE_P)		
			{
			switch (ch)
				{
				//control mode cases
		...
		else if (podWorker->controllerAdjustmode == CADJUSTMODE_D)		
			{
			switch (ch)
				{
				//control mode cases
